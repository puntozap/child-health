...
class VisitsController extends \TCG\Voyager\Http\Controllers\Controller
{
    ...
    //
    //****************************************
    public function graphicsVisit($child_id){
        // dd($child_id);
        $slug="visits";
    ...
    public function index(Request $request,$id)
    {
        ...
        $dataTypeContent=Visit::where("child_user_id",$id)->get();
        $User=User::find($id);
        // dd($User);
    ...
    public function edit(Request $request, $id,$child_id)
    {
        // $slug = $this->getSlug($request);
        // dd($id);
        $slug="visits";
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect("/admin/children/visits/".$request['child_id'])
        ->with([
