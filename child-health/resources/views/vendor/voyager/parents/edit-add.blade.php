...
@section('page_title', __('voyager::generic.'.($edit ? 'edit' : 'add')).' Representantes ')

@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i>
        {{ __('voyager::generic.'.($edit ? 'edit' : 'add')).' Representantes ' }}
    </h1>
                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="number" class="form-control" name="length" value="{{isset($dataTypeContent->length)?$dataTypeContent->length:''}}">
                            </div>
                            <div class="col-md-12">
                                <label for="">Peso</label>
                                <input type="number" class="form-control" name="weight" value="{{isset($dataTypeContent->weight)?$dataTypeContent->weight:''}}">
                            </div>
                            <div class="col-md-12">
                                ...
                                <select name="role_id" id="role_id" class="form-control select2">
                                    ...
                                    @foreach($Parent as $parent)
                                        <option value="{{$parent->id}}" {{isset($dataTypeContent->role_id)&&$dataTypeContent->role_id==$parent->id?"selected":""}}>{{$parent->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <input type="hidden" name="user_son_id" value="{{$id}}">
                        </div><!-- panel-body -->
